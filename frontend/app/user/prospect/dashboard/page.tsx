  ...
  const getNextSteps = (): NextStep[] => {
    ...
    if (!app) {
      steps.push({
        ...
        actionPath: '/user/prospect/prequalify',
        priority: 'high',
    ...
    if (app && !hasFullApp) {
      steps.push({
        ...
        actionPath: '/user/prospect/application',
        priority: 'high',
    ...
    if (hasFullApp && !allRequiredApproved && (appStatus === 'document_collection' || appStatus === 'under_review' || appStatus === 'submitted')) {
      steps.push({
        ...
        actionPath: '/user/prospect/documents',
        priority: 'high',
    ...
    if (hasFullApp && (appStatus === 'under_review' || appStatus === 'document_collection')) {
      steps.push({
        ...
        action: 'View Status',
        actionPath: '/user/prospect/status',
        priority: 'medium',
    ...
    if (steps.length === 0) {
      steps.push({
        ...
        action: 'View Profile',
        actionPath: '/user/prospect/profile',
        priority: 'low',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {stats.activeApplication?.application_type === 'prequalification' ? (
          <div className="pt-6 border-t border-[var(--core-gold)] pb-6">
            ...
            <button
              onClick={() => router.push('/user/prospect/application')}
          ...
          <div className="pt-6 border-t border-[var(--core-gold)] pb-6">
            ...
            <div className="mt-6 pt-6 border-t border-[var(--border)]">
              <button
                onClick={() => router.push('/user/prospect/status')}
