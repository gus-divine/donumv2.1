...
export default function MemberDetailPage() {
  ...
  function handleViewAllApplications() {
    router.push(`${basePath}/applications?applicant_id=${memberId}`);
  }

  function handleViewLoan(loan: Loan) {
    router.push(`${basePath}/loans/${loan.id}`);
  }

  function handleViewAllLoans() {
    router.push(`${basePath}/loans?applicant_id=${memberId}`);
  }
          ...
          <div className="pt-6 border-t border-[var(--core-blue)] pb-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {canEdit('/admin/loans') && (
                  <button
                    onClick={() => router.push(`${basePath}/loans?applicant_id=${memberId}`)}
                    className="text-sm text-[var(--core-blue)] dark:text-gray-400 hover:text-[var(--core-blue-light)] dark:hover:text-gray-300 transition-colors"
                  >
                    Add Loan
                  </button>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {canEdit('/admin/applications') && (
                  <button
                    onClick={() => router.push(`${basePath}/applications?applicant_id=${memberId}`)}
                    className="text-sm text-[var(--core-blue)] dark:text-gray-400 hover:text-[var(--core-blue-light)] dark:hover:text-gray-300 transition-colors"
                  >
                    Add Application
                  </button>
