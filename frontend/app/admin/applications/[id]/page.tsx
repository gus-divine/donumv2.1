...
export default function ApplicationDetailPage() {
  ...
  const { openChatForApplication, setApplicationContextFromPage } = useChatPanel();
  ...
  // Register application context so header chat button opens chat for this applicant
  useEffect(() => {
    if (application) {
      const applicantName =
      ...
      setApplicationContextFromPage({ applicationId: application.id, applicantName });
    } else {
      setApplicationContextFromPage(null);
    }
    return () => setApplicationContextFromPage(null);
  }, [application, setApplicationContextFromPage]);
  ...
  function handleEdit() {
    router.push(`${basePath}/applications/${applicationId}/edit`);
  }
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-[var(--core-blue)] dark:text-gray-400 hover:text-[var(--core-blue-light)] dark:hover:text-gray-300 transition-colors border border-[var(--core-blue)]/30 dark:border-gray-600 rounded-lg hover:bg-[var(--core-blue)]/5"
                >
