...
import { CreateApplicationForm } from '@/components/admin/applications/CreateApplicationForm';
...
export default function CreateApplicationPage() {
  ...
  function handleSuccess(applicationId: string) {
          ...
          <div className="mb-8 flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                Create a new application for an existing prospect or member
              </p>
            </div>
