            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2.5 border border-[var(--border)] rounded-lg bg-[var(--background)] text-sm font-medium text-[var(--text-primary)] placeholder-[var(--text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--core-blue)] focus:border-transparent transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={suggestPassword}
                  className="px-3 py-2.5 text-sm font-medium text-[var(--core-blue)] dark:text-gray-400 hover:text-[var(--core-blue-light)] dark:hover:text-gray-300 border border-[var(--border)] rounded-lg hover:bg-[var(--surface-hover)] transition-colors whitespace-nowrap"
                >
                  Suggest
                </button>
                <button
                  ...
                  disabled={!password}
                  className="px-3 py-2.5 text-sm font-medium text-[var(--core-blue)] dark:text-gray-400 hover:text-[var(--core-blue-light)] dark:hover:text-gray-300 border border-[var(--border)] rounded-lg hover:bg-[var(--surface-hover)] transition-colors whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                >
